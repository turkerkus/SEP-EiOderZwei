...
public class Deck {
    ...
    public Deck( ) {
        ...
        for (int i = 1; i < 11; i++) {
            ...
            deck.push(new Card(index++, "Koerner", new ImageIcon(getClass().getResource("/cards/drei.png").toString()), 3));
            ...
            deck.push(new Card(index++, "Biokörner", new ImageIcon(getClass().getResource("/cards/dreib.png").toString()), 3));
        }

        for (int j = 1; j < 9; j++) {
            deck.push(new Card(index++, "Biokörner", new ImageIcon(getClass().getResource("/cards/dreib.png").toString()), 1));
        }
