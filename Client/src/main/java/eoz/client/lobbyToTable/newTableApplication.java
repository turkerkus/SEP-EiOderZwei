...
public class newTableApplication extends Application {
    ...
    // used to bind all the necessary elements in newTableController
    public  void initializeBind(newTableController controller, Parent root){
